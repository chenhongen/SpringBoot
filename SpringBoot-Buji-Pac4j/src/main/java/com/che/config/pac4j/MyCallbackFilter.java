...
import com.che.config.pac4j.ShiroSessionStore;
import com.che.config.pac4j.ShiroProfileManager;
 ...
 * @since 2.0.0
 */
public class MyCallbackFilter implements Filter {
